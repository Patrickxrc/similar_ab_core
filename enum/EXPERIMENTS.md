...
python enum/compare_sim_ab_paths.py data/processed/facebook_circles_bipartite.txt 3 3 0.20 jaccard --algo r3 --max_iter 20 --ab_step 1
python enum/compare_sim_ab_paths.py data/processed/facebook_circles_bipartite.txt 3 3 0.20 jaccard --algo r4 --max_iter 20 --sim_step 0.02
```
